...
import time
start = time.time()
cols2profile = datasource.columns  # select all or some columns from the table
dprofile = dataprofile(datasource, cols2profile)
end = time.time()
print('Time taken to execute dataprofile function ', (end - start)/60,' minutes')


file_out = "cs_cuboid_vsb_retail_tbl" + '.csv'
